...
static int control(struct af_instance_s* af, int cmd, void* arg)
{
  ...
  case AF_CONTROL_REINIT:
    ...
    if(((struct af_data_s*)arg)->format == (AF_FORMAT_S16_NE)){
...
static void method1_int16(af_volnorm_t *s, struct af_data_s *c)
{
  register int i = 0;
...
static void method1_float(af_volnorm_t *s, struct af_data_s *c)
{
  register int i = 0;
...
static void method2_int16(af_volnorm_t *s, struct af_data_s *c)
{
  register int i = 0;
  int16_t *data = (int16_t*)c->audio;	// Audio data
  int len = c->len/2;		// Number of samples
...
static void method2_float(af_volnorm_t *s, struct af_data_s *c)
{
  register int i = 0;
  float *data = (float*)c->audio;	// Audio data
  int len = c->len/4;		// Number of samples
