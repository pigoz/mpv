...
#define AF_FORMAT_S8            (AF_FORMAT_I | AF_FORMAT_SI | AF_FORMAT_8BIT | \
                                 AF_FORMAT_NE)
#define AF_FORMAT_U16_LE        (AF_FORMAT_I | AF_FORMAT_US | AF_FORMAT_16BIT | \
                                 AF_FORMAT_LE)
#define AF_FORMAT_U16_BE        (AF_FORMAT_I | AF_FORMAT_US | AF_FORMAT_16BIT | \
                                 AF_FORMAT_BE)
#define AF_FORMAT_S16_LE        (AF_FORMAT_I | AF_FORMAT_SI | AF_FORMAT_16BIT | \
                                 AF_FORMAT_LE)
#define AF_FORMAT_S16_BE        (AF_FORMAT_I | AF_FORMAT_SI | AF_FORMAT_16BIT | \
                                 AF_FORMAT_BE)
#define AF_FORMAT_U24_LE        (AF_FORMAT_I | AF_FORMAT_US | AF_FORMAT_24BIT | \
                                 AF_FORMAT_LE)
#define AF_FORMAT_U24_BE        (AF_FORMAT_I | AF_FORMAT_US | AF_FORMAT_24BIT | \
                                 AF_FORMAT_BE)
#define AF_FORMAT_S24_LE        (AF_FORMAT_I | AF_FORMAT_SI | AF_FORMAT_24BIT | \
                                 AF_FORMAT_LE)
#define AF_FORMAT_S24_BE        (AF_FORMAT_I | AF_FORMAT_SI | AF_FORMAT_24BIT | \
                                 AF_FORMAT_BE)
#define AF_FORMAT_U32_LE        (AF_FORMAT_I | AF_FORMAT_US | AF_FORMAT_32BIT | \
                                 AF_FORMAT_LE)
#define AF_FORMAT_U32_BE        (AF_FORMAT_I | AF_FORMAT_US | AF_FORMAT_32BIT | \
                                 AF_FORMAT_BE)
#define AF_FORMAT_S32_LE        (AF_FORMAT_I | AF_FORMAT_SI | AF_FORMAT_32BIT | \
                                 AF_FORMAT_LE)
#define AF_FORMAT_S32_BE        (AF_FORMAT_I | AF_FORMAT_SI | AF_FORMAT_32BIT | \
                                 AF_FORMAT_BE)
...
#define AF_FORMAT_IEC61937_LE   (AF_FORMAT_IEC61937 | AF_FORMAT_16BIT | \
                                 AF_FORMAT_LE)
#define AF_FORMAT_IEC61937_BE   (AF_FORMAT_IEC61937 | AF_FORMAT_16BIT | \
                                 AF_FORMAT_BE)
